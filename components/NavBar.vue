    ...
    <div class="relative flex items-center justify-center h-16">
      <div class="flex items-center px-2 lg:px-0">
        <div class="lg:block lg:ml-6">
          <div class="flex">
            <a href="#" class="px-3 py-2 rounded-md text-xl leading-5 font-h1 font-medium text-retropink pink-glow transition duration-150 ease-in-out font-h1">David Parks</a>
