...
-->
<nav class="dark:bg-darkteal bg-lightblue nav">
        ...
        <div class="hidden sm:block sm:ml-6">
          <div class="flex">
            <div class="relative flex ml-4">
              <a @mouseover="showBlogSquiggle = true" @mouseout="showBlogSquiggle = false"  href="#" class="px-3 py-2 rounded-md text-sm font-h2 font-medium leading-5 text-gray-800 dark:text-gray-300 focus:outline-none transition duration-150 ease-in-out group">Blog</a>
              <ZigZag :class="{'opacity-100' : showBlogSquiggle}" class="w-12 transition-opacity opacity-0 duration-200 absolute text-retroteal left-0 right-0 top-0 mt-8 mx-auto"/>
            </div>
            <div class="relative flex ml-4">
              <a @mouseover="showProjectSquiggle = true" @mouseout="showProjectSquiggle = false" href="#" class="px-3 py-2 rounded-md text-sm font-h2 font-medium leading-5 text-gray-800 dark:text-gray-300 focus:outline-none transition duration-150 ease-in-out">Projects</a>
              <ZigZag2 :class="{'opacity-100' : showProjectSquiggle}" class="w-12 transition-opacity opacity-0 duration-200 absolute text-retroyellow left-0 right-0 top-0 mt-8 mx-auto"/>
            </div>
          </div>
        </div>
      </div>
